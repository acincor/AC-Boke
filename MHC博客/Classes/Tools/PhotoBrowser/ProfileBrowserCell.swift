...
import Foundation
import UIKit
protocol ProfileBrowserCellDelegate: NSObjectProtocol {
    func profileBrowserCellDidTapImage()
}
class ProfileBrowserCell: UICollectionViewCell {
    weak var photoDelegate: ProfileBrowserCellDelegate?
    @objc private func tapImage() {
        photoDelegate?.profileBrowserCellDidTapImage()
    }
    ...
    private lazy var placeHolder: ProfileProgressImageView = ProfileProgressImageView()
    private func reset() {
...
extension ProfileBrowserCell: UIScrollViewDelegate {
