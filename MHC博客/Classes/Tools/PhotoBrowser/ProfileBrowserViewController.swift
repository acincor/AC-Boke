...
import Photos
import UIKit
private let ProfileBrowserCellId = "ProfileBrowserCellId"
class ProfileBrowserViewController: UIViewController, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ProfileBrowserCellId, for: indexPath) as! ProfileBrowserCell
    ...
    private func prepare() {
        collectionView.register(ProfileBrowserCell.self, forCellWithReuseIdentifier: ProfileBrowserCellId)
...
extension ProfileBrowserViewController: ProfileBrowserCellDelegate {
    func profileBrowserCellDidTapImage() {
        imageViewForDimiss()
        close()
    }
}
extension ProfileBrowserViewController: ProfileBrowserDismissDelegate {
